// Header.jsx - Barra de navegacion con acceso Admin
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-semibold text-gray-900">RF Presupuestos</h1>
          ...
          <nav className="hidden md:flex items-center gap-1">
            <button
              onClick={() => onNavigate('calculadores')}
          ...
          <div className="flex items-center gap-4">
            <div className="text-right hidden sm:block">
              <p className="text-sm font-medium text-gray-900">{profile?.nombre || 'Usuario'}</p>
